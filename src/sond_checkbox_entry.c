...
G_DEFINE_TYPE_WITH_PRIVATE( SondCheckboxEntry, sond_checkbox_entry,
		GTK_TYPE_CHECK_BUTTON)

static void sond_checkbox_entry_class_init(SondCheckboxEntryClass *klass) {
...
static void sond_checkbox_entry_init(SondCheckboxEntry *self) {
...
gint sond_checkbox_entry_get_ID(SondCheckboxEntry *scbe) {
	SondCheckboxEntryPrivate *priv = NULL;
