...
static void _vala_seafile_repo_get_property(GObject *object, guint property_id,
		GValue *value, GParamSpec *pspec);
static void _vala_seafile_repo_set_property(GObject *object, guint property_id,
...
static inline gpointer seafile_repo_get_instance_private(SeafileRepo *self) {
...
void seafile_repo_set_id(SeafileRepo *self, const gchar *value) {
	...
	g_object_notify_by_pspec((GObject*) self,
			seafile_repo_properties[SEAFILE_REPO_ID_PROPERTY]);
}
...
void seafile_repo_set_name(SeafileRepo *self, const gchar *value) {
	...
	self->_name = _tmp0_;
	g_object_notify_by_pspec((GObject*) self,
			seafile_repo_properties[SEAFILE_REPO_NAME_PROPERTY]);
}
...
void seafile_repo_set_desc(SeafileRepo *self, const gchar *value) {
	...
	self->_desc = _tmp0_;
	g_object_notify_by_pspec((GObject*) self,
			seafile_repo_properties[SEAFILE_REPO_DESC_PROPERTY]);
}
...
void seafile_repo_set_version(SeafileRepo *self, gint value) {
	...
	if (seafile_repo_get_version(self) != value) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_VERSION_PROPERTY]);
	}
}
...
void seafile_repo_set_last_modify(SeafileRepo *self, gint value) {
	...
	if (seafile_repo_get_last_modify(self) != value) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_LAST_MODIFY_PROPERTY]);
	}
}
...
void seafile_repo_set_size(SeafileRepo *self, gint64 value) {
	...
	if (seafile_repo_get_size(self) != value) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_SIZE_PROPERTY]);
	}
}
...
void seafile_repo_set_file_count(SeafileRepo *self, gint64 value) {
	...
	if (seafile_repo_get_file_count(self) != value) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_FILE_COUNT_PROPERTY]);
	}
}
...
void seafile_repo_set_head_cmmt_id(SeafileRepo *self, const gchar *value) {
	...
	if (g_strcmp0(value, seafile_repo_get_head_cmmt_id(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_HEAD_CMMT_ID_PROPERTY]);
	}
}
...
void seafile_repo_set_root(SeafileRepo *self, const gchar *value) {
	...
	if (g_strcmp0(value, seafile_repo_get_root(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_ROOT_PROPERTY]);
	}
}
...
void seafile_repo_set_repo_id(SeafileRepo *self, const gchar *value) {
	...
	if (g_strcmp0(value, seafile_repo_get_repo_id(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_REPO_ID_PROPERTY]);
	}
}
...
void seafile_repo_set_repo_name(SeafileRepo *self, const gchar *value) {
	...
	if (g_strcmp0(value, seafile_repo_get_repo_name(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_REPO_NAME_PROPERTY]);
	}
}
...
void seafile_repo_set_repo_desc(SeafileRepo *self, const gchar *value) {
	...
	if (g_strcmp0(value, seafile_repo_get_repo_desc(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_REPO_DESC_PROPERTY]);
	}
}
...
void seafile_repo_set_last_modified(SeafileRepo *self, gint value) {
	...
	if (seafile_repo_get_last_modified(self) != value) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_LAST_MODIFIED_PROPERTY]);
	}
}
...
void seafile_repo_set_encrypted(SeafileRepo *self, gboolean value) {
	...
	if (seafile_repo_get_encrypted(self) != value) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_ENCRYPTED_PROPERTY]);
	}
}
...
void seafile_repo_set_magic(SeafileRepo *self, const gchar *value) {
	...
	if (g_strcmp0(value, seafile_repo_get_magic(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_MAGIC_PROPERTY]);
	}
}
...
void seafile_repo_set_enc_version(SeafileRepo *self, gint value) {
	...
	if (seafile_repo_get_enc_version(self) != value) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_ENC_VERSION_PROPERTY]);
	}
}
...
void seafile_repo_set_random_key(SeafileRepo *self, const gchar *value) {
	...
	if (g_strcmp0(value, seafile_repo_get_random_key(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_RANDOM_KEY_PROPERTY]);
	}
}
...
void seafile_repo_set_salt(SeafileRepo *self, const gchar *value) {
	...
	if (g_strcmp0(value, seafile_repo_get_salt(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_SALT_PROPERTY]);
	}
}
...
void seafile_repo_set_worktree(SeafileRepo *self, const gchar *value) {
	...
	g_object_notify_by_pspec((GObject*) self,
			seafile_repo_properties[SEAFILE_REPO_WORKTREE_PROPERTY]);
}
...
void seafile_repo_set_last_sync_time(SeafileRepo *self, gint value) {
	...
	if (seafile_repo_get_last_sync_time(self) != value) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_LAST_SYNC_TIME_PROPERTY]);
	}
}
...
void seafile_repo_set_auto_sync(SeafileRepo *self, gboolean value) {
	...
	if (seafile_repo_get_auto_sync(self) != value) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_AUTO_SYNC_PROPERTY]);
	}
}
...
void seafile_repo_set_worktree_invalid(SeafileRepo *self, gboolean value) {
	...
	if (seafile_repo_get_worktree_invalid(self) != value) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_WORKTREE_INVALID_PROPERTY]);
	}
}
...
void seafile_repo_set_is_virtual(SeafileRepo *self, gboolean value) {
	...
	if (seafile_repo_get_is_virtual(self) != value) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_IS_VIRTUAL_PROPERTY]);
	}
}
...
void seafile_repo_set_origin_repo_id(SeafileRepo *self, const gchar *value) {
	...
	if (g_strcmp0(value, seafile_repo_get_origin_repo_id(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_ORIGIN_REPO_ID_PROPERTY]);
	}
}
...
void seafile_repo_set_origin_repo_name(SeafileRepo *self, const gchar *value) {
	...
	if (g_strcmp0(value, seafile_repo_get_origin_repo_name(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_ORIGIN_REPO_NAME_PROPERTY]);
	}
}
...
void seafile_repo_set_origin_path(SeafileRepo *self, const gchar *value) {
	...
	if (g_strcmp0(value, seafile_repo_get_origin_path(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_ORIGIN_PATH_PROPERTY]);
	}
}
...
void seafile_repo_set_is_original_owner(SeafileRepo *self, gboolean value) {
	...
	if (seafile_repo_get_is_original_owner(self) != value) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_IS_ORIGINAL_OWNER_PROPERTY]);
	}
}
...
void seafile_repo_set_virtual_perm(SeafileRepo *self, const gchar *value) {
	...
	if (g_strcmp0(value, seafile_repo_get_virtual_perm(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_VIRTUAL_PERM_PROPERTY]);
	}
}
...
void seafile_repo_set_store_id(SeafileRepo *self, const gchar *value) {
	...
	if (g_strcmp0(value, seafile_repo_get_store_id(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_STORE_ID_PROPERTY]);
	}
}
...
void seafile_repo_set_is_corrupted(SeafileRepo *self, gboolean value) {
	...
	if (seafile_repo_get_is_corrupted(self) != value) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_IS_CORRUPTED_PROPERTY]);
	}
}
...
void seafile_repo_set_repaired(SeafileRepo *self, gboolean value) {
	...
	if (seafile_repo_get_repaired(self) != value) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_REPAIRED_PROPERTY]);
	}
}
...
void seafile_repo_set_share_type(SeafileRepo *self, const gchar *value) {
	...
	if (g_strcmp0(value, seafile_repo_get_share_type(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_SHARE_TYPE_PROPERTY]);
	}
}
...
void seafile_repo_set_permission(SeafileRepo *self, const gchar *value) {
	...
	if (g_strcmp0(value, seafile_repo_get_permission(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_PERMISSION_PROPERTY]);
	}
}
...
void seafile_repo_set_user(SeafileRepo *self, const gchar *value) {
	...
	if (g_strcmp0(value, seafile_repo_get_user(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_USER_PROPERTY]);
	}
}
...
void seafile_repo_set_group_id(SeafileRepo *self, gint value) {
	...
	if (seafile_repo_get_group_id(self) != value) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_GROUP_ID_PROPERTY]);
	}
}
...
void seafile_repo_set_is_shared(SeafileRepo *self, gboolean value) {
	...
	if (seafile_repo_get_is_shared(self) != value) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_repo_properties[SEAFILE_REPO_IS_SHARED_PROPERTY]);
	}
}
...
static void seafile_repo_class_init(SeafileRepoClass *klass,
	...
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_DESC_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_DESC_PROPERTY] =
					g_param_spec_string("desc", "desc", "desc", NULL,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_VERSION_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_VERSION_PROPERTY] =
					g_param_spec_int("version", "version", "version", G_MININT,
							G_MAXINT, 0,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_LAST_MODIFY_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_LAST_MODIFY_PROPERTY] =
					g_param_spec_int("last-modify", "last-modify",
							"last-modify", G_MININT, G_MAXINT, 0,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_SIZE_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_SIZE_PROPERTY] =
					g_param_spec_int64("size", "size", "size", G_MININT64,
							G_MAXINT64, 0,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_FILE_COUNT_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_FILE_COUNT_PROPERTY] =
					g_param_spec_int64("file-count", "file-count", "file-count",
	...
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_HEAD_CMMT_ID_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_HEAD_CMMT_ID_PROPERTY] =
					g_param_spec_string("head-cmmt-id", "head-cmmt-id",
							"head-cmmt-id", NULL,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_ROOT_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_ROOT_PROPERTY] =
					g_param_spec_string("root", "root", "root", NULL,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_REPO_ID_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_REPO_ID_PROPERTY] =
					g_param_spec_string("repo-id", "repo-id", "repo-id", NULL,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_REPO_NAME_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_REPO_NAME_PROPERTY] =
					g_param_spec_string("repo-name", "repo-name", "repo-name",
							NULL,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_REPO_DESC_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_REPO_DESC_PROPERTY] =
					g_param_spec_string("repo-desc", "repo-desc", "repo-desc",
							NULL,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_LAST_MODIFIED_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_LAST_MODIFIED_PROPERTY] =
					g_param_spec_int("last-modified", "last-modified",
							"last-modified", G_MININT, G_MAXINT, 0,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_ENCRYPTED_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_ENCRYPTED_PROPERTY] =
					g_param_spec_boolean("encrypted", "encrypted", "encrypted",
							FALSE,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_MAGIC_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_MAGIC_PROPERTY] =
					g_param_spec_string("magic", "magic", "magic", NULL,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_ENC_VERSION_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_ENC_VERSION_PROPERTY] =
					g_param_spec_int("enc-version", "enc-version",
							"enc-version", G_MININT, G_MAXINT, 0,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_RANDOM_KEY_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_RANDOM_KEY_PROPERTY] =
					g_param_spec_string("random-key", "random-key",
							"random-key", NULL,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_SALT_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_SALT_PROPERTY] =
					g_param_spec_string("salt", "salt", "salt", NULL,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_WORKTREE_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_WORKTREE_PROPERTY] =
					g_param_spec_string("worktree", "worktree", "worktree",
							NULL,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_RELAY_ID_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_RELAY_ID_PROPERTY] =
					g_param_spec_string("relay-id", "relay-id", "relay-id",
							NULL,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_LAST_SYNC_TIME_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_LAST_SYNC_TIME_PROPERTY] =
					g_param_spec_int("last-sync-time", "last-sync-time",
							"last-sync-time", G_MININT, G_MAXINT, 0,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_AUTO_SYNC_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_AUTO_SYNC_PROPERTY] =
					g_param_spec_boolean("auto-sync", "auto-sync", "auto-sync",
							FALSE,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_WORKTREE_INVALID_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_WORKTREE_INVALID_PROPERTY] =
					g_param_spec_boolean("worktree-invalid", "worktree-invalid",
							"worktree-invalid", FALSE,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_IS_VIRTUAL_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_IS_VIRTUAL_PROPERTY] =
					g_param_spec_boolean("is-virtual", "is-virtual",
							"is-virtual", FALSE,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_ORIGIN_REPO_ID_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_ORIGIN_REPO_ID_PROPERTY] =
					g_param_spec_string("origin-repo-id", "origin-repo-id",
							"origin-repo-id", NULL,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_ORIGIN_REPO_NAME_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_ORIGIN_REPO_NAME_PROPERTY] =
					g_param_spec_string("origin-repo-name", "origin-repo-name",
							"origin-repo-name", NULL,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_ORIGIN_PATH_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_ORIGIN_PATH_PROPERTY] =
					g_param_spec_string("origin-path", "origin-path",
							"origin-path", NULL,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_IS_ORIGINAL_OWNER_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_IS_ORIGINAL_OWNER_PROPERTY] =
					g_param_spec_boolean("is-original-owner",
							"is-original-owner", "is-original-owner", FALSE,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_VIRTUAL_PERM_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_VIRTUAL_PERM_PROPERTY] =
					g_param_spec_string("virtual-perm", "virtual-perm",
							"virtual-perm", NULL,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_STORE_ID_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_STORE_ID_PROPERTY] =
					g_param_spec_string("store-id", "store-id", "store-id",
							NULL,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_IS_CORRUPTED_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_IS_CORRUPTED_PROPERTY] =
					g_param_spec_boolean("is-corrupted", "is-corrupted",
							"is-corrupted", FALSE,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_REPAIRED_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_REPAIRED_PROPERTY] =
					g_param_spec_boolean("repaired", "repaired", "repaired",
							FALSE,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_SHARE_TYPE_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_SHARE_TYPE_PROPERTY] =
					g_param_spec_string("share-type", "share-type",
							"share-type", NULL,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_PERMISSION_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_PERMISSION_PROPERTY] =
					g_param_spec_string("permission", "permission",
							"permission", NULL,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_USER_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_USER_PROPERTY] =
					g_param_spec_string("user", "user", "user", NULL,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_GROUP_ID_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_GROUP_ID_PROPERTY] =
					g_param_spec_int("group-id", "group-id", "group-id",
							G_MININT, G_MAXINT, 0,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_REPO_IS_SHARED_PROPERTY,
			seafile_repo_properties[SEAFILE_REPO_IS_SHARED_PROPERTY] =
					g_param_spec_boolean("is-shared", "is-shared", "is-shared",
							FALSE,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
}

static void seafile_repo_instance_init(SeafileRepo *self, gpointer klass) {
...
GType seafile_repo_get_type(void) {
	...
	if (g_once_init_enter(&seafile_repo_type_id__volatile)) {
		static const GTypeInfo g_define_type_info = { sizeof(SeafileRepoClass),
				(GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL,
				(GClassInitFunc) seafile_repo_class_init,
				(GClassFinalizeFunc) NULL, NULL, sizeof(SeafileRepo), 0,
				(GInstanceInitFunc) seafile_repo_instance_init, NULL };
		GType seafile_repo_type_id;
		seafile_repo_type_id = g_type_register_static(G_TYPE_OBJECT,
				"SeafileRepo", &g_define_type_info, 0);
		SeafileRepo_private_offset = g_type_add_instance_private(
				seafile_repo_type_id, sizeof(SeafileRepoPrivate));
		g_once_init_leave(&seafile_repo_type_id__volatile,
				seafile_repo_type_id);
	}
...
static inline gpointer seafile_sync_task_get_instance_private(
...
void seafile_sync_task_set_force_upload(SeafileSyncTask *self, gboolean value) {
	...
	if (seafile_sync_task_get_force_upload(self) != value) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_sync_task_properties[SEAFILE_SYNC_TASK_FORCE_UPLOAD_PROPERTY]);
	}
}
...
void seafile_sync_task_set_repo_id(SeafileSyncTask *self, const gchar *value) {
	...
	if (g_strcmp0(value, seafile_sync_task_get_repo_id(self)) != 0) {
		...
		self->priv->_repo_id = _tmp0_;
		g_object_notify_by_pspec((GObject*) self,
				seafile_sync_task_properties[SEAFILE_SYNC_TASK_REPO_ID_PROPERTY]);
	}
}
...
void seafile_sync_task_set_state(SeafileSyncTask *self, const gchar *value) {
	...
	if (g_strcmp0(value, seafile_sync_task_get_state(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_sync_task_properties[SEAFILE_SYNC_TASK_STATE_PROPERTY]);
	}
}
...
void seafile_sync_task_set_error(SeafileSyncTask *self, gint value) {
	...
	if (seafile_sync_task_get_error(self) != value) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_sync_task_properties[SEAFILE_SYNC_TASK_ERROR_PROPERTY]);
	}
}
...
static void seafile_sync_task_class_init(SeafileSyncTaskClass *klass,
	...
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_SYNC_TASK_FORCE_UPLOAD_PROPERTY,
			seafile_sync_task_properties[SEAFILE_SYNC_TASK_FORCE_UPLOAD_PROPERTY] =
					g_param_spec_boolean("force-upload", "force-upload",
							"force-upload", FALSE,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
	...
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_SYNC_TASK_STATE_PROPERTY,
			seafile_sync_task_properties[SEAFILE_SYNC_TASK_STATE_PROPERTY] =
					g_param_spec_string("state", "state", "state", NULL,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_SYNC_TASK_ERROR_PROPERTY,
			seafile_sync_task_properties[SEAFILE_SYNC_TASK_ERROR_PROPERTY] =
					g_param_spec_int("error", "error", "error", G_MININT,
							G_MAXINT, 0,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
}
...
static void seafile_sync_task_finalize(GObject *obj) {
	SeafileSyncTask *self;
	self = G_TYPE_CHECK_INSTANCE_CAST(obj, SEAFILE_TYPE_SYNC_TASK,
			SeafileSyncTask);
	_g_free0(self->priv->_repo_id);
	_g_free0(self->priv->_state);
...
GType seafile_sync_task_get_type(void) {
	...
	if (g_once_init_enter(&seafile_sync_task_type_id__volatile)) {
		static const GTypeInfo g_define_type_info = {
				sizeof(SeafileSyncTaskClass), (GBaseInitFunc) NULL,
				(GBaseFinalizeFunc) NULL,
				(GClassInitFunc) seafile_sync_task_class_init,
				(GClassFinalizeFunc) NULL, NULL, sizeof(SeafileSyncTask), 0,
				(GInstanceInitFunc) seafile_sync_task_instance_init, NULL };
		GType seafile_sync_task_type_id;
		seafile_sync_task_type_id = g_type_register_static(G_TYPE_OBJECT,
				"SeafileSyncTask", &g_define_type_info, 0);
		SeafileSyncTask_private_offset = g_type_add_instance_private(
				seafile_sync_task_type_id, sizeof(SeafileSyncTaskPrivate));
		g_once_init_leave(&seafile_sync_task_type_id__volatile,
...
static void _vala_seafile_sync_task_get_property(GObject *object,
		guint property_id, GValue *value, GParamSpec *pspec) {
	SeafileSyncTask *self;
	self = G_TYPE_CHECK_INSTANCE_CAST(object, SEAFILE_TYPE_SYNC_TASK,
			SeafileSyncTask);
	switch (property_id) {
...
static inline gpointer seafile_session_info_get_instance_private(
...
void seafile_session_info_set_datadir(SeafileSessionInfo *self,
	...
	if (g_strcmp0(value, seafile_session_info_get_datadir(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_session_info_properties[SEAFILE_SESSION_INFO_DATADIR_PROPERTY]);
	}
}
...
static void seafile_session_info_class_init(SeafileSessionInfoClass *klass,
	...
	g_type_class_adjust_private_offset(klass,
			&SeafileSessionInfo_private_offset);
	G_OBJECT_CLASS(klass)->get_property =
			_vala_seafile_session_info_get_property;
	G_OBJECT_CLASS(klass)->set_property =
			_vala_seafile_session_info_set_property;
	G_OBJECT_CLASS(klass)->finalize = seafile_session_info_finalize;
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_SESSION_INFO_DATADIR_PROPERTY,
			seafile_session_info_properties[SEAFILE_SESSION_INFO_DATADIR_PROPERTY] =
					g_param_spec_string("datadir", "datadir", "datadir", NULL,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
}
...
static void seafile_session_info_finalize(GObject *obj) {
	SeafileSessionInfo *self;
	self = G_TYPE_CHECK_INSTANCE_CAST(obj, SEAFILE_TYPE_SESSION_INFO,
			SeafileSessionInfo);
	_g_free0(self->priv->_datadir);
...
GType seafile_session_info_get_type(void) {
	...
	if (g_once_init_enter(&seafile_session_info_type_id__volatile)) {
		static const GTypeInfo g_define_type_info = {
				sizeof(SeafileSessionInfoClass), (GBaseInitFunc) NULL,
				(GBaseFinalizeFunc) NULL,
				(GClassInitFunc) seafile_session_info_class_init,
				(GClassFinalizeFunc) NULL, NULL, sizeof(SeafileSessionInfo), 0,
				(GInstanceInitFunc) seafile_session_info_instance_init, NULL };
		GType seafile_session_info_type_id;
		seafile_session_info_type_id = g_type_register_static(G_TYPE_OBJECT,
				"SeafileSessionInfo", &g_define_type_info, 0);
		SeafileSessionInfo_private_offset = g_type_add_instance_private(
				seafile_session_info_type_id,
				sizeof(SeafileSessionInfoPrivate));
		g_once_init_leave(&seafile_session_info_type_id__volatile,
				seafile_session_info_type_id);
	}
...
static void _vala_seafile_session_info_get_property(GObject *object,
		guint property_id, GValue *value, GParamSpec *pspec) {
	SeafileSessionInfo *self;
	self = G_TYPE_CHECK_INSTANCE_CAST(object, SEAFILE_TYPE_SESSION_INFO,
			SeafileSessionInfo);
	switch (property_id) {
...
static inline gpointer seafile_diff_entry_get_instance_private(
...
void seafile_diff_entry_set_name(SeafileDiffEntry *self, const gchar *value) {
	...
	if (g_strcmp0(value, seafile_diff_entry_get_name(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_diff_entry_properties[SEAFILE_DIFF_ENTRY_NAME_PROPERTY]);
	}
}
...
void seafile_diff_entry_set_new_name(SeafileDiffEntry *self, const gchar *value) {
	...
	if (g_strcmp0(value, seafile_diff_entry_get_new_name(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_diff_entry_properties[SEAFILE_DIFF_ENTRY_NEW_NAME_PROPERTY]);
	}
}
...
static void seafile_diff_entry_class_init(SeafileDiffEntryClass *klass,
	...
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_DIFF_ENTRY_STATUS_PROPERTY,
			seafile_diff_entry_properties[SEAFILE_DIFF_ENTRY_STATUS_PROPERTY] =
					g_param_spec_string("status", "status", "status", NULL,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_DIFF_ENTRY_NAME_PROPERTY,
	...
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_DIFF_ENTRY_NEW_NAME_PROPERTY,
			seafile_diff_entry_properties[SEAFILE_DIFF_ENTRY_NEW_NAME_PROPERTY] =
					g_param_spec_string("new-name", "new-name", "new-name",
							NULL,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
}
...
static void seafile_diff_entry_finalize(GObject *obj) {
	SeafileDiffEntry *self;
	self = G_TYPE_CHECK_INSTANCE_CAST(obj, SEAFILE_TYPE_DIFF_ENTRY,
			SeafileDiffEntry);
	_g_free0(self->priv->_status);
	_g_free0(self->priv->_name);
	_g_free0(self->priv->_new_name);
...
GType seafile_diff_entry_get_type(void) {
	...
	if (g_once_init_enter(&seafile_diff_entry_type_id__volatile)) {
		static const GTypeInfo g_define_type_info = {
				sizeof(SeafileDiffEntryClass), (GBaseInitFunc) NULL,
				(GBaseFinalizeFunc) NULL,
				(GClassInitFunc) seafile_diff_entry_class_init,
				(GClassFinalizeFunc) NULL, NULL, sizeof(SeafileDiffEntry), 0,
				(GInstanceInitFunc) seafile_diff_entry_instance_init, NULL };
		GType seafile_diff_entry_type_id;
		seafile_diff_entry_type_id = g_type_register_static(G_TYPE_OBJECT,
				"SeafileDiffEntry", &g_define_type_info, 0);
		SeafileDiffEntry_private_offset = g_type_add_instance_private(
				seafile_diff_entry_type_id, sizeof(SeafileDiffEntryPrivate));
		g_once_init_leave(&seafile_diff_entry_type_id__volatile,
				seafile_diff_entry_type_id);
	}
...
static void _vala_seafile_diff_entry_get_property(GObject *object,
		guint property_id, GValue *value, GParamSpec *pspec) {
	SeafileDiffEntry *self;
	self = G_TYPE_CHECK_INSTANCE_CAST(object, SEAFILE_TYPE_DIFF_ENTRY,
			SeafileDiffEntry);
	switch (property_id) {
...
static inline gpointer seafile_encryption_info_get_instance_private(
...
void seafile_encryption_info_set_repo_id(SeafileEncryptionInfo *self,
	...
	if (g_strcmp0(value, seafile_encryption_info_get_repo_id(self)) != 0) {
		...
		self->priv->_repo_id = _tmp0_;
		g_object_notify_by_pspec((GObject*) self,
				seafile_encryption_info_properties[SEAFILE_ENCRYPTION_INFO_REPO_ID_PROPERTY]);
	}
}
...
void seafile_encryption_info_set_passwd(SeafileEncryptionInfo *self,
	...
	if (g_strcmp0(value, seafile_encryption_info_get_passwd(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_encryption_info_properties[SEAFILE_ENCRYPTION_INFO_PASSWD_PROPERTY]);
	}
}
...
void seafile_encryption_info_set_enc_version(SeafileEncryptionInfo *self,
	...
	if (seafile_encryption_info_get_enc_version(self) != value) {
		self->priv->_enc_version = value;
		g_object_notify_by_pspec((GObject*) self,
				seafile_encryption_info_properties[SEAFILE_ENCRYPTION_INFO_ENC_VERSION_PROPERTY]);
	}
}
...
void seafile_encryption_info_set_magic(SeafileEncryptionInfo *self,
	...
	if (g_strcmp0(value, seafile_encryption_info_get_magic(self)) != 0) {
		...
		self->priv->_magic = _tmp0_;
		g_object_notify_by_pspec((GObject*) self,
				seafile_encryption_info_properties[SEAFILE_ENCRYPTION_INFO_MAGIC_PROPERTY]);
	}
}
...
void seafile_encryption_info_set_random_key(SeafileEncryptionInfo *self,
	...
	if (g_strcmp0(value, seafile_encryption_info_get_random_key(self)) != 0) {
		...
		self->priv->_random_key = _tmp0_;
		g_object_notify_by_pspec((GObject*) self,
				seafile_encryption_info_properties[SEAFILE_ENCRYPTION_INFO_RANDOM_KEY_PROPERTY]);
	}
}
...
void seafile_encryption_info_set_salt(SeafileEncryptionInfo *self,
	...
	if (g_strcmp0(value, seafile_encryption_info_get_salt(self)) != 0) {
		...
		self->priv->_salt = _tmp0_;
		g_object_notify_by_pspec((GObject*) self,
				seafile_encryption_info_properties[SEAFILE_ENCRYPTION_INFO_SALT_PROPERTY]);
	}
}

static void seafile_encryption_info_class_init(
		SeafileEncryptionInfoClass *klass, gpointer klass_data) {
	seafile_encryption_info_parent_class = g_type_class_peek_parent(klass);
	g_type_class_adjust_private_offset(klass,
			&SeafileEncryptionInfo_private_offset);
	G_OBJECT_CLASS(klass)->get_property =
			_vala_seafile_encryption_info_get_property;
	G_OBJECT_CLASS(klass)->set_property =
			_vala_seafile_encryption_info_set_property;
	...
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_ENCRYPTION_INFO_PASSWD_PROPERTY,
			seafile_encryption_info_properties[SEAFILE_ENCRYPTION_INFO_PASSWD_PROPERTY] =
					g_param_spec_string("passwd", "passwd", "passwd", NULL,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_ENCRYPTION_INFO_ENC_VERSION_PROPERTY,
...
static void seafile_encryption_info_finalize(GObject *obj) {
	SeafileEncryptionInfo *self;
	self = G_TYPE_CHECK_INSTANCE_CAST(obj, SEAFILE_TYPE_ENCRYPTION_INFO,
			SeafileEncryptionInfo);
	_g_free0(self->priv->_repo_id);
	_g_free0(self->priv->_passwd);
	_g_free0(self->priv->_magic);
...
GType seafile_encryption_info_get_type(void) {
	...
	if (g_once_init_enter(&seafile_encryption_info_type_id__volatile)) {
		static const GTypeInfo g_define_type_info = {
				sizeof(SeafileEncryptionInfoClass), (GBaseInitFunc) NULL,
				(GBaseFinalizeFunc) NULL,
				(GClassInitFunc) seafile_encryption_info_class_init,
				(GClassFinalizeFunc) NULL, NULL, sizeof(SeafileEncryptionInfo),
				0, (GInstanceInitFunc) seafile_encryption_info_instance_init,
				NULL };
		GType seafile_encryption_info_type_id;
		seafile_encryption_info_type_id = g_type_register_static(G_TYPE_OBJECT,
				"SeafileEncryptionInfo", &g_define_type_info, 0);
		SeafileEncryptionInfo_private_offset = g_type_add_instance_private(
				seafile_encryption_info_type_id,
				sizeof(SeafileEncryptionInfoPrivate));
		g_once_init_leave(&seafile_encryption_info_type_id__volatile,
				seafile_encryption_info_type_id);
	}
...
static void _vala_seafile_encryption_info_get_property(GObject *object,
		guint property_id, GValue *value, GParamSpec *pspec) {
	SeafileEncryptionInfo *self;
	self = G_TYPE_CHECK_INSTANCE_CAST(object, SEAFILE_TYPE_ENCRYPTION_INFO,
			SeafileEncryptionInfo);
	switch (property_id) {
...
static inline gpointer seafile_file_sync_error_get_instance_private(
...
void seafile_file_sync_error_set_id(SeafileFileSyncError *self, gint value) {
	...
	if (seafile_file_sync_error_get_id(self) != value) {
		self->priv->_id = value;
		g_object_notify_by_pspec((GObject*) self,
				seafile_file_sync_error_properties[SEAFILE_FILE_SYNC_ERROR_ID_PROPERTY]);
	}
}
...
void seafile_file_sync_error_set_repo_id(SeafileFileSyncError *self,
	...
	if (g_strcmp0(value, seafile_file_sync_error_get_repo_id(self)) != 0) {
		...
		self->priv->_repo_id = _tmp0_;
		g_object_notify_by_pspec((GObject*) self,
				seafile_file_sync_error_properties[SEAFILE_FILE_SYNC_ERROR_REPO_ID_PROPERTY]);
	}
}
...
void seafile_file_sync_error_set_repo_name(SeafileFileSyncError *self,
	...
	if (g_strcmp0(value, seafile_file_sync_error_get_repo_name(self)) != 0) {
		...
		self->priv->_repo_name = _tmp0_;
		g_object_notify_by_pspec((GObject*) self,
				seafile_file_sync_error_properties[SEAFILE_FILE_SYNC_ERROR_REPO_NAME_PROPERTY]);
	}
}
...
void seafile_file_sync_error_set_path(SeafileFileSyncError *self,
	...
	if (g_strcmp0(value, seafile_file_sync_error_get_path(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_file_sync_error_properties[SEAFILE_FILE_SYNC_ERROR_PATH_PROPERTY]);
	}
}
...
void seafile_file_sync_error_set_err_id(SeafileFileSyncError *self, gint value) {
	...
	if (seafile_file_sync_error_get_err_id(self) != value) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_file_sync_error_properties[SEAFILE_FILE_SYNC_ERROR_ERR_ID_PROPERTY]);
	}
}
...
void seafile_file_sync_error_set_timestamp(SeafileFileSyncError *self,
	...
	if (seafile_file_sync_error_get_timestamp(self) != value) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_file_sync_error_properties[SEAFILE_FILE_SYNC_ERROR_TIMESTAMP_PROPERTY]);
	}
}

static void seafile_file_sync_error_class_init(SeafileFileSyncErrorClass *klass,
		gpointer klass_data) {
	seafile_file_sync_error_parent_class = g_type_class_peek_parent(klass);
	g_type_class_adjust_private_offset(klass,
			&SeafileFileSyncError_private_offset);
	G_OBJECT_CLASS(klass)->get_property =
			_vala_seafile_file_sync_error_get_property;
	G_OBJECT_CLASS(klass)->set_property =
			_vala_seafile_file_sync_error_set_property;
	G_OBJECT_CLASS(klass)->finalize = seafile_file_sync_error_finalize;
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_FILE_SYNC_ERROR_ID_PROPERTY,
			seafile_file_sync_error_properties[SEAFILE_FILE_SYNC_ERROR_ID_PROPERTY] =
					g_param_spec_int("id", "id", "id", G_MININT, G_MAXINT, 0,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_FILE_SYNC_ERROR_REPO_ID_PROPERTY,
	...
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_FILE_SYNC_ERROR_ERR_ID_PROPERTY,
			seafile_file_sync_error_properties[SEAFILE_FILE_SYNC_ERROR_ERR_ID_PROPERTY] =
					g_param_spec_int("err-id", "err-id", "err-id", G_MININT,
							G_MAXINT, 0,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_FILE_SYNC_ERROR_TIMESTAMP_PROPERTY,
			seafile_file_sync_error_properties[SEAFILE_FILE_SYNC_ERROR_TIMESTAMP_PROPERTY] =
					g_param_spec_int64("timestamp", "timestamp", "timestamp",
							G_MININT64, G_MAXINT64, 0,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
}

static void seafile_file_sync_error_instance_init(SeafileFileSyncError *self,
		gpointer klass) {
...
static void seafile_file_sync_error_finalize(GObject *obj) {
	SeafileFileSyncError *self;
	self = G_TYPE_CHECK_INSTANCE_CAST(obj, SEAFILE_TYPE_FILE_SYNC_ERROR,
			SeafileFileSyncError);
	_g_free0(self->priv->_repo_id);
	_g_free0(self->priv->_repo_name);
	_g_free0(self->priv->_path);
...
GType seafile_file_sync_error_get_type(void) {
	...
	if (g_once_init_enter(&seafile_file_sync_error_type_id__volatile)) {
		static const GTypeInfo g_define_type_info = {
				sizeof(SeafileFileSyncErrorClass), (GBaseInitFunc) NULL,
				(GBaseFinalizeFunc) NULL,
				(GClassInitFunc) seafile_file_sync_error_class_init,
				(GClassFinalizeFunc) NULL, NULL, sizeof(SeafileFileSyncError),
				0, (GInstanceInitFunc) seafile_file_sync_error_instance_init,
				NULL };
		GType seafile_file_sync_error_type_id;
		seafile_file_sync_error_type_id = g_type_register_static(G_TYPE_OBJECT,
				"SeafileFileSyncError", &g_define_type_info, 0);
		SeafileFileSyncError_private_offset = g_type_add_instance_private(
				seafile_file_sync_error_type_id,
				sizeof(SeafileFileSyncErrorPrivate));
		g_once_init_leave(&seafile_file_sync_error_type_id__volatile,
				seafile_file_sync_error_type_id);
	}
...
static void _vala_seafile_file_sync_error_get_property(GObject *object,
		guint property_id, GValue *value, GParamSpec *pspec) {
	SeafileFileSyncError *self;
	self = G_TYPE_CHECK_INSTANCE_CAST(object, SEAFILE_TYPE_FILE_SYNC_ERROR,
			SeafileFileSyncError);
	switch (property_id) {
