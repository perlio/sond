...
static void _vala_seafile_task_get_property(GObject *object, guint property_id,
		GValue *value, GParamSpec *pspec);
static void _vala_seafile_task_set_property(GObject *object, guint property_id,
...
static inline gpointer seafile_task_get_instance_private(SeafileTask *self) {
...
void seafile_task_set_ttype(SeafileTask *self, const gchar *value) {
	...
	if (g_strcmp0(value, seafile_task_get_ttype(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_task_properties[SEAFILE_TASK_TTYPE_PROPERTY]);
	}
}
...
void seafile_task_set_repo_id(SeafileTask *self, const gchar *value) {
	...
	if (g_strcmp0(value, seafile_task_get_repo_id(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_task_properties[SEAFILE_TASK_REPO_ID_PROPERTY]);
	}
}
...
void seafile_task_set_state(SeafileTask *self, const gchar *value) {
	...
	if (g_strcmp0(value, seafile_task_get_state(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_task_properties[SEAFILE_TASK_STATE_PROPERTY]);
	}
}
...
void seafile_task_set_rt_state(SeafileTask *self, const gchar *value) {
	...
	if (g_strcmp0(value, seafile_task_get_rt_state(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_task_properties[SEAFILE_TASK_RT_STATE_PROPERTY]);
	}
}
...
void seafile_task_set_block_total(SeafileTask *self, gint64 value) {
	...
	if (seafile_task_get_block_total(self) != value) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_task_properties[SEAFILE_TASK_BLOCK_TOTAL_PROPERTY]);
	}
}
...
void seafile_task_set_block_done(SeafileTask *self, gint64 value) {
	...
	if (seafile_task_get_block_done(self) != value) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_task_properties[SEAFILE_TASK_BLOCK_DONE_PROPERTY]);
	}
}
...
void seafile_task_set_fs_objects_total(SeafileTask *self, gint value) {
	...
	if (seafile_task_get_fs_objects_total(self) != value) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_task_properties[SEAFILE_TASK_FS_OBJECTS_TOTAL_PROPERTY]);
	}
}
...
void seafile_task_set_rate(SeafileTask *self, gint value) {
	...
	if (seafile_task_get_rate(self) != value) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_task_properties[SEAFILE_TASK_RATE_PROPERTY]);
	}
}
...
static void seafile_task_class_init(SeafileTaskClass *klass,
	...
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_TASK_TTYPE_PROPERTY,
			seafile_task_properties[SEAFILE_TASK_TTYPE_PROPERTY] =
					g_param_spec_string("ttype", "ttype", "ttype", NULL,
	...
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_TASK_RT_STATE_PROPERTY,
			seafile_task_properties[SEAFILE_TASK_RT_STATE_PROPERTY] =
					g_param_spec_string("rt-state", "rt-state", "rt-state",
							NULL,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_TASK_BLOCK_TOTAL_PROPERTY,
			seafile_task_properties[SEAFILE_TASK_BLOCK_TOTAL_PROPERTY] =
					g_param_spec_int64("block-total", "block-total",
							"block-total", G_MININT64, G_MAXINT64, 0,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_TASK_BLOCK_DONE_PROPERTY,
			seafile_task_properties[SEAFILE_TASK_BLOCK_DONE_PROPERTY] =
					g_param_spec_int64("block-done", "block-done", "block-done",
	...
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_TASK_FS_OBJECTS_TOTAL_PROPERTY,
			seafile_task_properties[SEAFILE_TASK_FS_OBJECTS_TOTAL_PROPERTY] =
					g_param_spec_int("fs-objects-total", "fs-objects-total",
							"fs-objects-total", G_MININT, G_MAXINT, 0,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_TASK_FS_OBJECTS_DONE_PROPERTY,
			seafile_task_properties[SEAFILE_TASK_FS_OBJECTS_DONE_PROPERTY] =
					g_param_spec_int("fs-objects-done", "fs-objects-done",
							"fs-objects-done", G_MININT, G_MAXINT, 0,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
	g_object_class_install_property(G_OBJECT_CLASS(klass),
			SEAFILE_TASK_RATE_PROPERTY,
			seafile_task_properties[SEAFILE_TASK_RATE_PROPERTY] =
					g_param_spec_int("rate", "rate", "rate", G_MININT, G_MAXINT,
							0,
							G_PARAM_STATIC_STRINGS | G_PARAM_READABLE
									| G_PARAM_WRITABLE));
}

static void seafile_task_instance_init(SeafileTask *self, gpointer klass) {
...
GType seafile_task_get_type(void) {
	...
	if (g_once_init_enter(&seafile_task_type_id__volatile)) {
		static const GTypeInfo g_define_type_info = { sizeof(SeafileTaskClass),
				(GBaseInitFunc) NULL, (GBaseFinalizeFunc) NULL,
				(GClassInitFunc) seafile_task_class_init,
				(GClassFinalizeFunc) NULL, NULL, sizeof(SeafileTask), 0,
				(GInstanceInitFunc) seafile_task_instance_init, NULL };
		GType seafile_task_type_id;
		seafile_task_type_id = g_type_register_static(G_TYPE_OBJECT,
				"SeafileTask", &g_define_type_info, 0);
		SeafileTask_private_offset = g_type_add_instance_private(
				seafile_task_type_id, sizeof(SeafileTaskPrivate));
		g_once_init_leave(&seafile_task_type_id__volatile,
				seafile_task_type_id);
	}
...
static inline gpointer seafile_clone_task_get_instance_private(
...
void seafile_clone_task_set_state(SeafileCloneTask *self, const gchar *value) {
	...
	if (g_strcmp0(value, seafile_clone_task_get_state(self)) != 0) {
		...
		self->priv->_state = _tmp0_;
		g_object_notify_by_pspec((GObject*) self,
				seafile_clone_task_properties[SEAFILE_CLONE_TASK_STATE_PROPERTY]);
	}
}
...
void seafile_clone_task_set_error(SeafileCloneTask *self, gint value) {
	...
	if (seafile_clone_task_get_error(self) != value) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_clone_task_properties[SEAFILE_CLONE_TASK_ERROR_PROPERTY]);
	}
}
...
void seafile_clone_task_set_repo_id(SeafileCloneTask *self, const gchar *value) {
	...
	if (g_strcmp0(value, seafile_clone_task_get_repo_id(self)) != 0) {
		...
		self->priv->_repo_id = _tmp0_;
		g_object_notify_by_pspec((GObject*) self,
				seafile_clone_task_properties[SEAFILE_CLONE_TASK_REPO_ID_PROPERTY]);
	}
}
...
void seafile_clone_task_set_repo_name(SeafileCloneTask *self,
	...
	if (g_strcmp0(value, seafile_clone_task_get_repo_name(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_clone_task_properties[SEAFILE_CLONE_TASK_REPO_NAME_PROPERTY]);
	}
}
...
void seafile_clone_task_set_worktree(SeafileCloneTask *self, const gchar *value) {
	...
	if (g_strcmp0(value, seafile_clone_task_get_worktree(self)) != 0) {
		...
		g_object_notify_by_pspec((GObject*) self,
				seafile_clone_task_properties[SEAFILE_CLONE_TASK_WORKTREE_PROPERTY]);
	}
}
...
static void seafile_clone_task_finalize(GObject *obj) {
	SeafileCloneTask *self;
	self = G_TYPE_CHECK_INSTANCE_CAST(obj, SEAFILE_TYPE_CLONE_TASK,
			SeafileCloneTask);
	_g_free0(self->priv->_state);
	_g_free0(self->priv->_repo_id);
	_g_free0(self->priv->_repo_name);
...
GType seafile_clone_task_get_type(void) {
	...
	if (g_once_init_enter(&seafile_clone_task_type_id__volatile)) {
		static const GTypeInfo g_define_type_info = {
				sizeof(SeafileCloneTaskClass), (GBaseInitFunc) NULL,
				(GBaseFinalizeFunc) NULL,
				(GClassInitFunc) seafile_clone_task_class_init,
				(GClassFinalizeFunc) NULL, NULL, sizeof(SeafileCloneTask), 0,
				(GInstanceInitFunc) seafile_clone_task_instance_init, NULL };
		GType seafile_clone_task_type_id;
		seafile_clone_task_type_id = g_type_register_static(G_TYPE_OBJECT,
				"SeafileCloneTask", &g_define_type_info, 0);
		SeafileCloneTask_private_offset = g_type_add_instance_private(
				seafile_clone_task_type_id, sizeof(SeafileCloneTaskPrivate));
		g_once_init_leave(&seafile_clone_task_type_id__volatile,
				seafile_clone_task_type_id);
	}
...
static void _vala_seafile_clone_task_get_property(GObject *object,
		guint property_id, GValue *value, GParamSpec *pspec) {
	SeafileCloneTask *self;
	self = G_TYPE_CHECK_INSTANCE_CAST(object, SEAFILE_TYPE_CLONE_TASK,
			SeafileCloneTask);
	switch (property_id) {
