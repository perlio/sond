...
void widgets_adresse_geaendert(GObject *window, gboolean geaendert) {
...
void widgets_adresse_waehlen(GObject *window, gboolean waehlen) {
	gtk_widget_activate_get_sensitive(
			GTK_WIDGET(g_object_get_data(G_OBJECT(window), "grid")), waehlen);
	/*
