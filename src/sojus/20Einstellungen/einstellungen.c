...
static void cb_select_db(GtkWidget *button, gpointer data) {
	gchar *dbname = NULL;
...
static void cb_connect(GtkWidget *button, gpointer data) {
	Sojus *sojus = (Sojus*) data;
...
static void cb_file_set(GtkWidget *button, gpointer data) {
	Sojus *sojus = (Sojus*) data;
...
void einstellungen(GtkWidget *button, gpointer data) {
	Sojus *sojus = (Sojus*) data;
